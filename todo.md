# Leak Detective Revision Checklist

- [x] Define a hypothesis-led hierarchy with confidence and scope indicators.
- [x] Replace the primary dashboard composition with evidence, timeline, and suspect allocation views.
